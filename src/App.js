...
<section className='bg-hero-pattern'>
  <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
    <div class="flex flex-col w-full mb-12 text-center">
      ...
      <h1 class="max-w-3xl text-2xl font-bold leading-none tracking-tighter text-neutral-600 md:text-5xl lg:text-6xl lg:max-w-7xl">
...
<section class="bg-white">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 flex-col justify-center">
      <div class="max-w-screen-md mb-8 lg:mb-16 flex-col justify-center">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-600">Designed for business teams like yours</h2>
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold text-gray-600">Legal</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold text-gray-600">Business Automation</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold text-gray-600">Finance</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold text-gray-600">Enterprise Design</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold text-gray-600">Operations</h3>
...
<section class="text-gray-900 body-font">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center max-w-6xl">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <p class="mb-8 leading-relaxed text-gray-400">Are you an experienced guitar player looking to break through creative barriers? Our Personalized One-on-One guitar classes are designed specifically for individuals like you who need personalized attention and tailored feedback instruction to conquer your unique goals and challenges.
</p>
...
<section class="text-gray-600 body-font ">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center  max-w-6xl">
    ...
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <p class="mb-8 leading-relaxed">Confused what to do with your musical talents? Book a session with us and we will help you find your way. 
