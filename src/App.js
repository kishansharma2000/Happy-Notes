...
import './App.css';
import bgimg from '../src/assets/WhatsApp Image 2023-07-16 at 8.47.32 PM.jpeg'
...
<section className='bg-hero-pattern' style={{background:`url('${bgimg}')no-repeat cover`}}>
  <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
    <div class="flex flex-col w-full mb-12 text-center">
      ...
      <h1 class="max-w-3xl text-2xl font-bold leading-none tracking-tighter text-neutral-1000 md:text-5xl lg:text-6xl lg:max-w-7xl">
      Ignite your passion for guitar and embark on <br class="hidden lg:block"/>
      a melodious journey of musical excellence
      </h1>

      <p class="max-w-xl mx-auto mt-8 text-base leading-relaxed text-center text-gray-500">No matter your age or prior musical experience, we believe that everyone can learn to play guitar by breaking 
down complex techniques into easy-to-understand concepts.</p>
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center max-w-6xl">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div class="flex justify-center">
        <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" control-id="ControlID-111">Button</button>
